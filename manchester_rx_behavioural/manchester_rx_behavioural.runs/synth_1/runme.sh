...
HD_PWD='/home/ukallakuri/hardware_design/designs/manchester_tx_rx/manchester_rx_behavioural/manchester_rx_behavioural.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Manchester_rx_uart_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Manchester_rx_uart_top.tcl
