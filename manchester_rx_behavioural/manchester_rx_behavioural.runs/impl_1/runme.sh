...
HD_PWD='/home/ukallakuri/hardware_design/designs/manchester_tx_rx/manchester_rx_behavioural/manchester_rx_behavioural.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Manchester_rx_uart_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Manchester_rx_uart_top.tcl -notrace
