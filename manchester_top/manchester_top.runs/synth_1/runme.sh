...
HD_PWD='/home/ukallakuri/hardware_design/designs/manchester_tx_rx/manchester_top/manchester_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log manchester_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source manchester_top.tcl
