...
HD_PWD='/home/ukallakuri/hardware_design/designs/manchester_tx_rx/manchester_top/manchester_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log manchester_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source manchester_top.tcl -notrace
