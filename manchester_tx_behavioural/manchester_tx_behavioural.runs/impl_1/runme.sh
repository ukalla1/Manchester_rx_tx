...
HD_PWD='/home/ukallakuri/hardware_design/designs/manchester_tx_rx/manchester_tx_behavioural/manchester_tx_behavioural.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log manchester_tx_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source manchester_tx_top.tcl -notrace
